            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                                ...
                                <div class="row">
                                    <div class="party">
                                        <ul class="multi-column-dropdown">
                                            <li><a href="/about">Current Elections</a></li>
                                            <li class="divider"></li>
                                            <li><a href="/about">Past Elections</a></li>
                                            <li class="divider"></li>
                                            <li><a href="/about">Future Elections</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </ul>
                        ...
                        <li><a href="/codes">Campaigns</a></li>
